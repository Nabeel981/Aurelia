Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/5557d2d4a62284247b08570b806baccc"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.851 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.602 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.382 /*_MochieReflectionStrength*/);
				specularMask *= (0.963 /*_MochieSpecularStrength*/);
