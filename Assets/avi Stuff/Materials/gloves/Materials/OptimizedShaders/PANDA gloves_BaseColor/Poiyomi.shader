Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/feffc731eb74a2647a3f899bbbb7144d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.29 /*_AlphaMod*/));
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (18.89 /*_EmissionStrength*/);
