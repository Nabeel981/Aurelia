Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/6d4e23eb2d74f1e478ec145432e32098"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.987 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.962 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.664 /*_MochieReflectionStrength*/);
				specularMask *= (0.722 /*_MochieSpecularStrength*/);
