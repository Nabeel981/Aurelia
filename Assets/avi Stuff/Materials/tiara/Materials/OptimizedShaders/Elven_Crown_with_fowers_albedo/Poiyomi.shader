Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/31bb6f1875703be4589be3b21182a6c1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				half3 glitterColor = poiThemeColor(poiMods, float4(0.04307583,0.1331992,0.8301887,1), (0.0 /*_GlitterColorThemeIndex*/));
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.991 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.822 /*_MochieReflectionStrength*/);
				specularMask *= (0.988 /*_MochieSpecularStrength*/);
